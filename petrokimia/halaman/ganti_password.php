				...
				<form role="form" method="POST" class="form-horizontal form-groups-bordered" action="ganti_password_act.php">
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<input type="hidden" class="form-control" id="field-1" name="kode_ky" value="<?php echo $_SESSION[''];?>" readonly />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="baru"	required />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="ulang"	required />
						</div>
					</div>

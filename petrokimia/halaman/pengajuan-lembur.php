...
<hr />
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="pengajuan-lembur.php"><strong>Pengajuan Lembur</strong></a>
					</li>
					</ol>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal form-groups-bordered" method="POST" action="act-lembur.php">
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label">Proyek</label>
						
						<div class="col-sm-5">
							<textarea class="form-control" name="proyek_ky" required /></textarea>
							<input type="hidden" class="form-control" name="nik_ky" value="<?php echo $_SESSION['nik'];?>" readonly />
							<input type="hidden" class="form-control" name="nama_ky" value="<?php echo $_SESSION['nama'];?>" readonly />
							<input type="hidden" class="form-control" name="unit_ky" value="<?php echo $_SESSION['kode_unitkerja'];?>" readonly />
<?php $kd = $_SESSION['kode_unitkerja'];?>
					<?php

		$hasil = $db->QUERY("SELECT kode_atasan FROM  tabel_unitkerja WHERE  kode_unit ='$kd';");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="time" class="form-control" id="field-file" placeholder="Placeholder" name="mulai_ky" required />
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-ta" class="col-sm-3 control-label">Akhir Lembur</label>
						
						<div class="col-sm-5">
							<input type="time" class="form-control" id="field-file" placeholder="Placeholder" name="akhir_ky" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" name="ket_ky" required /></textarea>
						</div>
					</div>

...
<hr />
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="draft_absensi.php"><strong>Pengajuan Cuti</strong></a>
					</li>
					</ol><br>
<legend>
<h2>Data Draft Cuti Saya</h2>
</legend><br>
...
<table class="table table-bordered datatable">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_absensi WHERE persetujuan LIKE '%draft%' AND nik ='$kd';");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		<td><!--<a href="edit_dabsensi.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-sm btn-icon icon-left">
					<i class="entypo-doc-text-inv"></i>
					Edit
				</a>-->
				<a href="hapus_dd.php?id=<?php echo $row['id'];?>" class="btn btn-danger	 btn-sm btn-icon icon-left" onclick="return confirm('Apakah Anda yakin ingin menghapus ini?');">
					<i class="entypo-trash"></i>
					Hapus
				</a>
				<a href="ajukan2.php?id=<?php echo $row['id'];?>" class="btn btn-success	 btn-sm btn-icon icon-left">

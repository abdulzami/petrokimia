...
$u2130=mysql_query("SELECT COUNT(usia) FROM data_karyawan WHERE usia >= 21 AND usia <= 30");
$usia2130=mysql_result($u2130, 0);//usia 21 - 30
$u3135=mysql_query("SELECT COUNT(usia) FROM data_karyawan WHERE usia >= 31 AND usia <= 35");
$usia3135=mysql_result($u3135, 0);//usia 31 - 35
$u3640=mysql_query("SELECT COUNT(usia) FROM data_karyawan WHERE usia >= 36 AND usia <= 40");
$usia3640=mysql_result($u3640, 0);//usia 36 - 40
$u4145=mysql_query("SELECT COUNT(usia) FROM data_karyawan WHERE usia >= 41 AND usia <= 45");
$usia4145=mysql_result($u4145, 0);//usia 41 - 45
$u4650=mysql_query("SELECT COUNT(usia) FROM data_karyawan WHERE usia >= 46 AND usia <= 50");
$usia4650=mysql_result($u4650, 0);//usia 46 - 50
$u50=mysql_query("SELECT COUNT(usia) FROM data_karyawan WHERE usia > 50");
$usia50=mysql_result($u50, 0);//usia > 50
?>
<?php
include 'koneksicharts.php';
$psmk=mysql_query("SELECT COUNT(pendidikan) FROM data_karyawan WHERE pendidikan ='SMK'");
$pendsmk=mysql_result($psmk, 0);//SMK
$psma=mysql_query("SELECT COUNT(pendidikan) FROM data_karyawan WHERE pendidikan ='SMA'");
$pendsma=mysql_result($psma, 0);//SMA
$ps1=mysql_query("SELECT COUNT(pendidikan) FROM data_karyawan WHERE pendidikan ='S1'");
$pends1=mysql_result($ps1, 0);//S1
$ps2=mysql_query("SELECT COUNT(pendidikan) FROM data_karyawan WHERE pendidikan ='S2'");
$pends2=mysql_result($ps2, 0);//S2
$ps3=mysql_query("SELECT COUNT(pendidikan) FROM data_karyawan WHERE pendidikan ='S3'");
$pends3=mysql_result($ps3, 0);//S3
$pd3=mysql_query("SELECT COUNT(pendidikan) FROM data_karyawan WHERE pendidikan ='D3'");
$pendd3=mysql_result($pd3, 0);//D3
$k='karyawan'
?>
<?php
$lk=mysql_query("SELECT COUNT(jenis_kelamin) FROM data_karyawan WHERE jenis_kelamin ='Laki-Laki'");
$laki=mysql_result($lk, 0);//Laki-Laki
$pr=mysql_query("SELECT COUNT(jenis_kelamin) FROM data_karyawan WHERE jenis_kelamin ='Perempuan'");
...
$label6='2022';
//PENSIUN
$d1=mysql_query("SELECT COUNT(b.tahun_pensiun) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='lama' AND tahun_pensiun='$label1'");
$data1=mysql_result($d1, 0);//data1 sesuai label 1
$d2=mysql_query("SELECT COUNT(b.tahun_pensiun) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='lama' AND tahun_pensiun='$label2'");
$data2=mysql_result($d2, 0);//data2 sesuai label 2
$d3=mysql_query("SELECT COUNT(b.tahun_pensiun) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='lama' AND tahun_pensiun='$label3'");
$data3=mysql_result($d3, 0);//data3 sesuai label 3
$d4=mysql_query("SELECT COUNT(b.tahun_pensiun) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='lama' AND tahun_pensiun='$label4'");
$data4=mysql_result($d4, 0);//data4 sesuian label 4
$d5=mysql_query("SELECT COUNT(b.tahun_pensiun) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='lama' AND tahun_pensiun='$label5'");
$data5=mysql_result($d5, 0);//data5 sesuai label 5
$d6=mysql_query("SELECT COUNT(b.tahun_pensiun) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='lama' AND tahun_pensiun='$label6'");
$data6=mysql_result($d6, 0);//data6 sesuai label 6
//MASUK
$m1=mysql_query("SELECT COUNT(b.tahun_masuk) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='baru' AND tahun_masuk='$label1';");
$mdata1=mysql_result($m1, 0);//data1 sesuai label 1
$m2=mysql_query("SELECT COUNT(b.tahun_masuk) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='baru' AND tahun_masuk='$label2';");
$mdata2=mysql_result($m2, 0);//data1 sesuai label 1
$m3=mysql_query("SELECT COUNT(b.tahun_masuk) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='baru' AND tahun_masuk='$label3';");
$mdata3=mysql_result($m3, 0);//data1 sesuai label 1
$m4=mysql_query("SELECT COUNT(b.tahun_masuk) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='baru' AND tahun_masuk='$label4';");
$mdata4=mysql_result($m4, 0);//data1 sesuai label 1
$m5=mysql_query("SELECT COUNT(b.tahun_masuk) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='baru' AND tahun_masuk='$label5';");
$mdata5=mysql_result($m5, 0);//data1 sesuai label 1
$m6=mysql_query("SELECT COUNT(b.tahun_masuk) FROM data_karyawan a,periode_kerja b WHERE a.nik=b.nik AND b.status='baru' AND tahun_masuk='$label6';");
$mdata6=mysql_result($m6, 0);//data1 sesuai label 1
?>

<?php
$pend=1;	
$angka=mysql_query("SELECT COUNT(institusi_pendidikan) AS zami FROM data_karyawan WHERE institusi_pendidikan <> '-' GROUP BY institusi_pendidikan;");
$pendi=mysql_query("SELECT institusi_pendidikan,COUNT(institusi_pendidikan) AS zami FROM data_karyawan WHERE institusi_pendidikan <> '-' GROUP BY institusi_pendidikan;");
$angkaj=mysql_query("SELECT COUNT(jurusan) as jurus FROM data_karyawan WHERE institusi_pendidikan <> '-' GROUP BY jurusan;");
$jurusan=mysql_query("SELECT jurusan FROM data_karyawan WHERE institusi_pendidikan <> '-' GROUP BY jurusan;");
            ...
            <div class="container-fluid">	
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Tahun Pensiun - Tahun Masuk</h3>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Jenis Kelamin</h3>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading blue">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Pendidikan <div class="label label-success">Linked</div></h3>
                            </div>
                            <div class="panel-body">
...
<div class="row">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Perbandingan Usia</h3>
                            </div>
                            <div class="panel-body">
                                <div id="grafik"></div>
                            </div>
 ...
 <script>
    ...
    Morris.Donut({
        ...
        if (row == 1) {
            window.location.href = 'pends.php?pend=SMA';
       } else if (row == 2) {
            window.location.href = 'pends.php?pend=S1';
        } else if (row == 3) {
            window.location.href = 'pends.php?pend=S2';
        } else if (row == 4) {
            window.location.href = 'pends.php?pend=S3';
         } else if (row == 5) {
            window.location.href = 'pends.php?pend=D3'; 
        } else {
            //kalau pakai modal bootstrap
            window.location.href = 'pends.php?pend=SMK';
        }
    });

...
<div class="profile-env">
	...
	<section class="profile-info-tabs">
		...
		<div class="row">
			...
			<div class="col-sm-offset-2 col-sm-10">
				...
				<ul class="user-details">
					...
					<i class="entypo-lock"></i>
					<?php
		$hasil = $db->QUERY("SELECT * FROM tabel_unitkerja WHERE  kode_unit ='$kdku';");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		...
		endforeach;
		?>
					Kode Unit Kerja : <?php echo $row['kode_unitkerja']?>

					</li>
					<li>
					<i class="entypo-home"></i>
					Nama Unit Kerja : <?php echo $rower['jenis_unitkerja']?> <?php echo $rower['nama_unitkerja']?>
					</li>
					<li>
					...
					<li>
					<i class="entypo-trophy"></i>
					Institut Pendidikan : <?php echo $row['institut_pendidikan']?>
					</li>
					<li>
					<i class="entypo-trophy"></i>

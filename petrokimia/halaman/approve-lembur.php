...
<table class="table table-bordered datatable">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_lembur WHERE persetujuan LIKE '%menunggu%' AND kode_atasan = $uk");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
...
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_lembur WHERE persetujuan LIKE '%setuju%' AND kode_atasan = $uk");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>

...
?>
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="ganti_password.php"><strong>Ganti Password</strong></a>
					</li>
					</ol>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" method="POST" class="form-horizontal form-groups-bordered" action="ganti_password_act.php">
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label">Password Lama</label>
						
						<div class="col-sm-5">
							<input type="password" class="form-control" id="field-1" name="lama"	required />
							<input type="hidden" class="form-control" id="field-1" name="kode_ky" value="<?php echo $_SESSION['kode'];?>" readonly />

...
<hr />
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="data_karyawan.php"><strong>Data Karyawan</strong></a>
					</li>
					</ol><br>
<h2>Data Karyawan Saya</h2><br>
</legend>
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM tabel_karyawan WHERE pabrik = '$pb' AND level='Karyawan'");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		<td><center>
				<a href="profil-karyawan.php?id=<?php echo $row['id'];?>" class="btn btn-default btn-sm btn-icon icon-left">

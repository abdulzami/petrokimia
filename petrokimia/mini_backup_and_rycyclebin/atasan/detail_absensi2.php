...
<hr /><div class="profile-env">
	...
	$id=$_GET['id'];
		...
		$kode=$row['kode_karyawan'];
			?>
			<?php
			$hasilku = $db->QUERY("SELECT foto FROM tabel_karyawan WHERE kode_karyawan='$kode'");
		...
		<div class="row">
			...
			<div class="col-sm-offset-2 col-sm-10">
				...
				<ul class="user-details">	
					...
					Mulai Tanggal : <?php echo $row['mulai_absensi']?>
					</li>
										<li>
										<i class="entypo-user"></i>
					Sampai Tanggal : <?php echo $row['akhir_absensi']?>
					</li>
										<li>
					...
					Persetujuan : <?php echo $row['persetujuan']?>
										...
										<li>
										<i class="entypo-trophy"></i>
					Waktu Pengajuan : <?php echo $row['waktu_pengajuan'];?>
					</li>
				</ul>

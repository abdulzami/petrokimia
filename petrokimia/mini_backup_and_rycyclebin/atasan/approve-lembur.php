...
<hr />
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="approve-lembur.php"><strong>Approve Lembur</strong></a>
					</li>
					</ol><br>
<legend>
...
<table class="table table-bordered datatable">
	<thead>
		<tr>
			...
			<th>Kode Karyawan</th>
			<th data-hide="phone,tablet">Nama Karyawan</th>
			<th>Keterangan</th>
			<th>Persetujuan</th>
			<th>Action</th>
		</tr>
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_lembur WHERE persetujuan LIKE '%menunggu%' AND pabrik ='$pb';");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		<a href="setuju-lembur.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon icon-right">
					...
					<a href="detail_lembur.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-sm btn-icon icon-right">
...
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_lembur WHERE persetujuan LIKE '%setuju%' AND pabrik ='$pb';");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		<a href="setuju-lembur.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon icon-right">
					...
					Tidak Setuju
										...
										<a href="batal_lembur.php?id=<?php echo $row['id'];?>" class="btn btn-warning btn-sm btn-icon icon-right">
					<i class="entypo-cancel"></i>
					Batalkan
				</a>
					<a href="detail_lembur2.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-sm btn-icon icon-right">
					<i class="entypo-info"></i>
					Detail
				</a>	
		</td>

...
$kode=$row['kode_karyawan'];
			...
			<a href="#" class="profile-picture">
				<img src="../karyawan/uploads/<?php echo $row['foto'];?>" class="img-responsive img-circle" />
			</a>
			...
			<ul class="profile-info-sections">
				<li>
					<div class="profile-name">
						...
						<span><a href="#">Karyawan di  <?php echo $row['pabrik'];?></a></span>
					</div>
				</li>
			</ul>
...
<div class="col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="panel-title">Data Pengajuan Lembur <b><?php echo $row['nama_karyawan']?></b></div>
...
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_lembur WHERE kode_karyawan= '$kode'");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		...
		<tr class="odd gradeX">
		<td><?php echo $no; ?></td>
		<td><?php echo $rowr['proyek']; ?></td>
		<td><?php echo $rowr['mulai_lembur']; ?></td>
		<td><?php echo $rowr['akhir_lembur']; ?></td>
		<td><?php echo $rowr['persetujuan']; ?></td>
		<td><?php echo $rowr['ket']; ?></td>
...
<div class="col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="panel-title">Data Pengajuan Absensi <b><?php echo $row['nama_karyawan']?></b></div>
...
<table class="table table-bordered datatable" id="table-10">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT * FROM pengajuan_absensi WHERE kode_karyawan= '$kode'");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $rowr):
						?>
		<tr class="odd gradeX">
		<td><?php echo $no; ?></td>
		<td><?php echo $rowr['alasan']; ?></td>
		<td><?php echo $rowr['mulai_absensi']; ?></td>
		<td><?php echo $rowr['akhir_absensi']; ?></td>
		<td><?php echo $rowr['persetujuan']; ?></td>
		<td><?php echo $rowr['ket']; ?></td>

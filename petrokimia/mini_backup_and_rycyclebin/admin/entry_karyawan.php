...
<div class="col-sm-12">
				...
				<li class="active">
							...
							<a href="data_karyawan.php"><strong>Entry Karyawan</strong></a>
					</li>
					</ol><br>
<h2>Entry Karyawan</h2><br>
</legend>
<div class="row">
	<div class="col-md-12">
...
// membuat query max
  $carikode = mysqli_query($koneksi, "select max(kode_karyawan) from tabel_karyawan") or die (mysql_error());
  // menjadikannya array
...
?>  
				<form role="form" method="POST" class="form-horizontal form-groups-bordered" action="karyawan_act.php">
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label">Kode Karyawan</label>
						
						<div class="col-sm-5">
							<input type="text" class="form-control" name="kode_ky" value="<?php echo $kode_otomatis;?>" readonly />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="nama_ky" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="usia_ky" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="institut_ky" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="jurusan_ky" required />
						</div>
					</div>

...
<div class="col-sm-12">
				...
				<li class="active">
							...
							<a href="data_karyawan.php"><strong>Sign Up</strong></a>
					</li>
					</ol><br>
<h2>Sign Up</h2><br>
</legend>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" method="POST" class="form-horizontal form-groups-bordered" action="sign2.php">
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label">Kode Karyawan</label>
						
						<div class="col-sm-5">
							<input type="text" class="form-control" id="kode" name="kode_ky" reqired placeholder="Cari Kode Karyawan . . ." required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="level_ky" required />
								<option value="0"  required >Pilih Level</option>
								<option  required >karyawan</option>
								<option  required >atasan</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="user_ky" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" name="pass_ky" required />
						</div>
					</div>

...
<div class="col-sm-12">
				...
				<li class="active">
							...
							<a href="karyawan_lama.php"><strong>Data Karyawan Lama</strong></a>
					</li>
					</ol><br>
<h2>Data Karyawan Lama</h2><br>
</legend>
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT a.nama_karyawan,a.kode_karyawan,b.status_karyawan,a.id FROM tabel_karyawan a,periode_kerja b WHERE a.kode_karyawan=b.kode_karyawan AND b.status_karyawan = 'lama'  AND level = 'karyawan'");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		<td><center>
				<a href="profil_lama.php?id=<?php echo $row['id'];?>" class="btn btn-default btn-sm btn-icon icon-left">
					<i class="entypo-info"></i>
					Profile
				</a>
				<a href="edit_lama.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-sm btn-icon icon-left">
					<i class="entypo-doc-text"></i>
					Edit
				</a>

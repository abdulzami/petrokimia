...
if(isset($_POST))
{
	...
	include 'koneksi.php';
	$nama_file = $_FILES['ImageFile']['name'];
	$kode = $_POST['kode'];
	$query = "UPDATE tabel_karyawan SET foto='thumb_$nama_file' where kode_karyawan = '$kode'";
	...
	$ImageName 		= $_FILES['ImageFile']['name']; //get image name

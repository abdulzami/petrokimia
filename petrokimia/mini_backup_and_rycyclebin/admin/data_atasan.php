...
<body class="page-body  page-fade-only" class="page-body" data-url="http://neon.dev">
...
<div class="col-sm-12">
				...
				<li class="active">
							...
							<a href="data_atasan.php"><strong>Data Atasan</strong></a>
					</li>
					</ol><br>
...
<table class="table table-bordered datatable" id="table-1">
	...
	<tbody>
	<?php
		$hasil = $db->QUERY("SELECT a.nama_karyawan,a.kode_karyawan,b.status_karyawan,a.id,a.foto FROM tabel_karyawan a,periode_kerja b WHERE a.kode_karyawan=b.kode_karyawan AND level = 'atasan'");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $row):
						?>
		...
		<td><center>
				<a href="profil_atasan.php?id=<?php echo $row['id'];?>" class="btn btn-default btn-sm btn-icon icon-left">
					<i class="entypo-info"></i>
					Profile
				</a>
				<a href="edit_atasan.php?id=<?php echo $row['id'];?>" class="btn btn-info btn-sm btn-icon icon-left">

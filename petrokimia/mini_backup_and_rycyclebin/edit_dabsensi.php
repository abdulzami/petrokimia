...
<div class="col-sm-12">
				...
				<li>
					...
					<li>
							...
							<a href="table-absensi.php">Pengajuan Absensi</a>
					</li>
					<li class="active">
...
<h2>Edit Pengajuan Absensi</h2><br>
</legend>
<div class="row">
	<div class="col-md-12">
...
$kode=$row['nik'];
			...
			<div class="panel-body">
						<form role="form" method="POST" class="form-horizontal form-groups-bordered" action="update_dabsensi.php">
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label""">Alasan</label>
						
						<div class="col-sm-5">	
							<textarea class="form-control" name="alasan_ky" required /><?php echo $row['alasan']?></textarea>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="date" class="form-control" name="mulai_ky" value="<?php echo $row['mulai_absensi'];?>" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="date" class="form-control" name="akhir_ky" value="<?php echo $row['akhir_absensi'];?>" required />
						</div>
					</div>
		...
		$hasil = $db->QUERY("SELECT tahun_kemarin FROM pengajuan_absensi WHERE id = $id;");
		$rows = $hasil-> fetch_All(MYSQLI_ASSOC);
		$no =1;
		foreach ($rows as $rowt):
						?>
		
					<input type="hidden" class="form-control" name="gila" value="<?php echo $rowt['tahun_kemarin'];?>" readonly /><?php
		$no++;
		endforeach;
		?>
					<div class="form-group">
